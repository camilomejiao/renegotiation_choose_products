...
import {
    ...
    FaSearchDollar,
    FaRoute,
    FaUserCog, FaRegAddressBook, FaBoxes, FaTools, FaLeaf, FaUserCheck,
} from 'react-icons/fa';
...
const menuConfig = {
    [RolesEnum.ADMIN]: [
        ...
        { path: "/admin/search-beneficiary-information", icon: FaRegAddressBook, label: "Consultar Beneficiario" },
