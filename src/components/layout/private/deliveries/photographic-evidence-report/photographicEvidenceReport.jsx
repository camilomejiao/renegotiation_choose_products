...
export const PhotographicEvidenceReport = ({deliveryInformation}) => {
        ...
        <>
            <div id="report-section">
                    ...
                    <tr>
                        ...
                        <td style={{ width: '70%', borderTop: '1px solid black', textAlign: 'center' }}>
                            <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                                <tbody>
                                <tr>
                                    <td colSpan="4" style={{ borderBottom: '1px solid black', textAlign: 'center', padding: '5px' }}>REGISTRO FOTOGRÁFICO</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style={{ borderRight: '1px solid black', textAlign: 'center', padding: '5px' }}>Versión: 01</td>
                                    <td style={{ textAlign: 'center', padding: '5px' }}>Fecha de publicación: </td>
                                </tr>
                                </tbody>
                            </table>
                        </td>
                ...
                <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                    ...
                    <tr>
                        <td style={{
                            ...
                            NOMBRE BENEFICIARIO: {deliveryInformation?.cub?.nombre}
                        </td>
                        <td style={{
                            width: '30%',
                            textAlign: 'left',
                        ...
                        <td style={{
                            ...
                            No CÉDULA: {deliveryInformation?.cub?.identificacion}
                        </td>
                    </tr>
                    <tr>
                        <td style={{
                            ...
                            DEPARTAMENTO: {deliveryInformation?.cub?.departamento}
                        </td>
                        <td style={{
                            textAlign: 'left',
                            borderTop: '1px solid black',
                            ...
                            MUNICIPIO: {deliveryInformation?.cub?.municipio}
                        </td>
                        <td style={{
                            textAlign: 'left',
                            borderTop: '1px solid black',
                            ...
                            VEREDA / TERRITORIO COLECTIVO ÉTNICO: {deliveryInformation?.cub?.vereda}
                        </td>
                    </tr>
                    <tr>
                        <td style={{
                            ...
                            TIPO DE PLAN: {deliveryInformation?.cub?.plan}
                        </td>
                        <td style={{
                            textAlign: 'left',
                            border: '1px solid black'
                        }} colSpan={2}>
                            LINEA PRODUCTIVA: {deliveryInformation?.cub?.linea}
                        </td>
                    </tr>
                    </thead>
                </table>
                ...
                <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                    <thead>
                    <tr>
                        <td style={{ textAlign: 'center', border: '1px solid black', backgroundColor: 'gray' }}>
