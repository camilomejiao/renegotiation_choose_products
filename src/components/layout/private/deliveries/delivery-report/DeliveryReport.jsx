...
export const DeliveryReport = ({deliveryInformation}) => {
    ...
    const date = new Date(deliveryInformation?.fecha_creacion);
                ...
                <table style={{borderCollapse: 'collapse', width: '100%'}}>
                    <thead>
                        <tr>
                            ...
                            <td style={{textAlign: 'center', border: '1px solid black'}}>Estado</td>
                        </tr>
                    </thead>
                    <tbody>
                    {products?.map((product) => {
                        ...
                        return (
                            <tr key={product?.producto?.id}>
                                <td style={{textAlign: 'left', border: '1px solid black'}}>{product?.producto?.nombre}</td>
                                <td style={{textAlign: 'left', border: '1px solid black'}}>{product?.producto?.especificacion_tecnicas}</td>
                                <td style={{textAlign: 'center', border: '1px solid black'}}>{product?.producto?.unidad}</td>
                                <td style={{textAlign: 'center', border: '1px solid black'}}>{valorPorUnidad}</td>
                                <td style={{textAlign: 'center', border: '1px solid black'}}>{cantidad}</td>
                                <td style={{textAlign: 'center', border: '1px solid black'}}>{valorFinal.toLocaleString('es-CO')}</td>
                                <td style={{textAlign: 'center', border: '1px solid black'}}>{estado.label}</td>
                            </tr>
                        );
                    })}
                    </tbody>
                ...
                <table style={{borderCollapse: 'collapse', width: '100%'}}>
                    ...
                    <tr>
                        <td colSpan="4" style={{
                            ...
                            <b>Con la suscripción de la presente acta manifiesto que los elementos recibidos los voy a
                                utilizar única y exclusivamente para el desarrollo de mi proyecto productivo
                                como titular o beneficiario de la DSCI y que acepto que se realicen las labores de
                                seguimiento y/o verificación de su destinación y adecuada utilización.</b>
                        </td>
                    </tr>
                    <tr>
                        <td colSpan="4"
                            style={{textAlign: 'center', border: '1px solid black', fontSize: '9px'}}>Titular(es) y/o
                            beneficiario(s) que recibe(n) los elementos o activos productivos se relaciona(n) a
                            continuación:
                        </td>
                    </tr>
                    <tr>
                        <td style={{
                            ...
                            border: '1px solid black',
                            padding: '15px'
                        }}>Nombre completo del titular y/o del beneficiario
                        </td>
