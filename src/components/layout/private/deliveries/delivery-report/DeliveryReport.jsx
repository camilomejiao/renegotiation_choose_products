            ...
            <div id="report-section">
                ...
                <table style={{borderCollapse: 'collapse', width: '100%'}}>
                    <thead>
                        ...
                        <tr>
                            <td colSpan={4} style={{textAlign: 'left', fontStyle: 'italic', border: '1px solid black'}}>
                                NOTA: En caso de que reciba un tercero, se debe adjuntar el poder o autorización suscrita por el titular (Firma y huella)
                            </td>
                        </tr>
                    </thead>
                </table>
