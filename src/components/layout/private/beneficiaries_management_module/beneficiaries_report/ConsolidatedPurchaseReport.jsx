                ...
                <table style={{ borderCollapse: "collapse", width: "100%" }}>
                  <tbody>
                    ...
                    <tr>
                      ...
                      >
                        SUSTITUCIÓN DE CULTIVOS DE USO ILÍCITO Y TRÁNSITO A LA
                        LEGALIDAD
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td style={{ textAlign: "center", padding: "5px" }}>
                        Fecha de publicación: preliminar
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <table style={{ borderCollapse: "collapse", width: "100%" }}>
          <thead>
            ...
            <tr>
              ...
              <td style={{ border: "1px solid black", textAlign: "center" }}>
                {dataReport?.departamento}
              </td>
              <td style={{ border: "1px solid black" }}>
                <strong>Municipio</strong>
              </td>
              <td style={{ border: "1px solid black", textAlign: "center" }}>
                {dataReport?.municipio}
              </td>
              <td style={{ border: "1px solid black" }}>
                <strong>VEREDA / TERRITORIO COLECTIVO ÉTNICO:</strong>
              </td>
              <td style={{ border: "1px solid black", textAlign: "center" }}>
                {dataReport?.vereda}
              </td>
            ...
            <tr>
              <td style={{ border: "1px solid black" }}>
                <strong>Línea Productiva Seleccionada</strong>
              </td>
              <td
            ...
            <tr>
              <td style={{ width: "18%", border: "1px solid black" }}>
                <strong>SALDO TOTAL PLAN DE INVERSIÓN:</strong>
              </td>
              <td
                style={{
                  width: "10%",
              ...
              >
                ${" "}
                {parseFloat(dataReport?.saldo).toLocaleString("es-CO", {
                  minimumFractionDigits: 0,
                  maximumFractionDigits: 0,
                })}
              </td>
              <td style={{ width: "15%", border: "1px solid black" }}>
                <strong>VALOR TOTAL INVERTIDO</strong>
              </td>
              <td
                style={{
                  width: "15%",
              ...
              >
                {" "}
                $ {parseFloat(dataReport?.invertido).toLocaleString()}
              </td>
              <td style={{ width: "25%", border: "1px solid black" }}>
                <strong>SALDO FINAL DESPUES DE INVERSIÓN :</strong>
              </td>
              <td
                style={{
                  width: "12%",
              ...
              >
                ${" "}
                {parseFloat(
                  dataReport?.saldo - dataReport?.invertido
