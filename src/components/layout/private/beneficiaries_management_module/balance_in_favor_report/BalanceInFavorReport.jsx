...
export const BalanceInFavorReport = ({dataReport}) => {
    ...
    // Calcula la diferencia y la redondea al peso más cercano
    ...
    const valorEnLetras = numeroALetras(valor).toUpperCase(); // en mayúsculas
    // Sugerencia típica para dinero en Colombia:
                        ...
                        <tr>
                            ...
                            <td style={{ width: '70%', borderTop: '1px solid black', textAlign: 'center' }}>
                                <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                                    <tbody>
                                    <tr>
                                        <td colSpan="4" style={{ borderBottom: '1px solid black', textAlign: 'center', padding: '5px' }}>AGENCIA DE RENOVACIÓN DEL TERRITORIO DIRECCIÓN DE SUSTITUCIÓN DE CULTIVOS DE USO ILÍCITO</td>
                                    </tr>
                                    <tr>
                    ...
                    <thead>
                        <tr>
                            ...
                            >
                                ...
                                consentimiento expreso, inequívoco, informado e irrevocable del
                                titular del núcleo familiar beneficiario vinculado al Programa
                                Nacional Integral de Sustitución de Cultivos de Uso Ilícito (PNIS)
                                para la renuncia, y posterior reasignación definitiva hacia el
                                componente de Asistencia Técnica Integral (ATI), de los saldos que
                                quedaran pendientes de entrega en el marco de la implementación de su
                                proyectos productivos (de ciclo corto, largo o renegociados),{" "}
                                <strong>
                                    cuando, en atención a su cuantía, resultan materialmente
                                    inejecutables, toda vez que no son suficientes para destinarse a la
                                    adquisición de ningún bien o servicio en el marco de las ferias de
                                    proveedores.
                                </strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            >
                                Así, la formalización del consentimiento por parte del beneficiario
                                del programa PNIS resulta un requisito indispensable para efectos de
                                la determinación posterior de la terminación formal de la vinculación
                                del titular frente a los compromisos derivados de la implementación
                                del programa. En este sentido, la identificación precisa de estos
                                saldos y su registro mediante el presente instrumento asegura la
                                transparencia, trazabilidad y responsabilidad en la administración de
                                los recursos públicos, en consonancia con los principios de
                                publicidad, moralidad y buena fe que rigen la función administrativa.
                            </td>
                        </tr>
                        <tr>
                            <td
                            ...
                            >
                                ...
                                suscripción de este instrumento el titular PNIS identificado/a más
                                adelante acepta que los saldos de su CUB aquí señalados sean
                                reorientados globalmente al componente de Asistencia Técnica Integral
                                (ATI), en aplicación de los principios de eficiencia, eficacia y
                                economía previstos en el artículo 3 del Código de Procedimiento
                                Administrativo y de lo Contencioso Administrativo (CPACA), con el fin
                                de fortalecer las acciones de acompañamiento técnico a los
                                beneficiarios del programa y optimizar así el impacto del PNIS
                    ...
                    <thead>
                        <tr>
                            ...
                            >
                                ...
                                identificado(a) con la cédula de ciudadanía No. <strong>{dataReport?.cedula}</strong>,
                                titular del núcleo familiar beneficiario del Programa Nacional Integral de Sustitución de Cultivos de Uso Ilícito PNIS,
                                identificado mediante el Código Único de Beneficiario (CUB) No. <strong>{dataReport?.cub_id}</strong>, en nombre propio y en representación de mi núcleo familiar,
                                manifiesto de manera libre, expresa, voluntaria e informada mi decisión de renunciar y reasignar, de forma global,
                                al componente de Asistencia Técnica Integral (ATI) el saldo remanente a mi favor que se encuentra registrado en las bases de datos del Programa,
                                por valor de: <strong>$ {valorFormateado}</strong>, <strong>{leyendaLetras}</strong>.
                                Lo anterior, en atención a que,  durante la ejecución de los componentes de ciclo corto y de ciclo largo renegociados en aplicación de lo dispuesto en el
                                artículo 10 de la Ley 2294 de 2023 y en la Resolución 0021 de 2024, mediante las ferias agropecuarias y no agropecuarias
                                desarrolladas por la DSCI en las cuales se consolidaron las órdenes de compra correspondientes a mi línea productiva, se generaron
                                valores inejecutables en razón de su cuantía, resultando imposible su ejecución en el esquema de implementación definido por el Programa.
                            </td>
                        </tr>
                        <tr>
                            <td
                            ...
                            >
                                En consecuencia, autorizo que el saldo remanente del CUB de mi núcleo familiar, pendiente de ejecución,
                                sea descontado de manera definitiva y adicionado al componente de Asistencia Técnica Integral (ATI) del Programa,
                                con el fin de culminar el proceso de intervención y determinar la posterior finalización de mi vinculación con el PNIS.
                            </td>
                        </tr>
                        <tr>
                            <td
                            ...
                            >
                                De esta manera, los recursos destinados a estas labores serán administrados de acuerdo con las condiciones y
                                requisitos establecidos por la Dirección de Sustitución de Cultivos de Uso Ilícito (DSCI), de la Agencia de
                                Renovación del Territorio (ART), para el apoyo permanente a la implementación de los proyectos productivos.
                            </td>
                        </tr>
                        <tr>
                            <td
                            ...
                            >
                                En constancia de lo anterior, firmo la presente declaración el día <strong>{day}</strong> del mes <strong>{month}</strong> del año <strong>{year}</strong>,
