            ...
            <div className="main-container">
                ...
                <div className="search-banner-reports beneficiaries-actions">
                    <Container>
                        ...
                        <Row className="justify-content-start mt-2 gy-2">
                            <Col xs={12} md={3} className="beneficiaries-actions__primary">
                                <button
