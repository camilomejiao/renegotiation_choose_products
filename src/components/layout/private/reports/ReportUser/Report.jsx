                ...
                <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                    <thead>
                        <tr>
                            ...
                            <td style={{ border: '1px solid black', textAlign: 'center' }}>978966</td>
                            <td style={{ border: '1px solid black' }}><strong>NOMBRE TITULAR:</strong></td>
                            <td style={{ width: '20%', border: '1px solid black', textAlign: 'center' }}>NELLY EMILSE AMAYA CHAVARRIA</td>
                            <td style={{ border: '1px solid black' }}><strong>No. CÉDULA:</strong></td>
                            <td style={{ border: '1px solid black', textAlign: 'center' }}>36.278.775</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid black' }}><strong>Departamento</strong></td>
                            <td style={{ border: '1px solid black', textAlign: 'center' }}>ANTIOQUIA</td>
                            <td style={{ border: '1px solid black' }}><strong>Municipio</strong></td>
                            <td style={{ border: '1px solid black', textAlign: 'center' }}>ITUANGO</td>
                            <td style={{ border: '1px solid black' }}><strong>VEREDA / TERRITORIO COLECTIVO ÉTNICO:</strong></td>
                            <td style={{ border: '1px solid black', textAlign: 'center' }}>SANTA LUCIA</td>
                        </tr>
                        <tr>
                            <td style={{ border: '1px solid black' }}><strong>Línea Productiva Seleccionada</strong></td>
                            <td style={{ border: '1px solid black', textAlign: 'center' }} colSpan="5">Pecuaria</td>
                        </tr>
                        <tr>
                            <td style={{ width: '18%', border: '1px solid black' }}><strong>SALDO TOTAL PLAN DE INVERSIÓN:</strong></td>
                            <td style={{ width: '10%', border: '1px solid black', textAlign: 'center' }}> $ 14.000.196</td>
                            ...
                            <td style={{ width: '12%', border: '1px solid black', textAlign: 'center' }}> $ 14.000.196</td>
                        </tr>
                    </thead>
                </table>
                ...
                <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                    <thead>
                        <tr>
                            ...
                            <td style={{ width: '4%', textAlign: 'center', border: '1px solid black' }}>CANTIDAD</td>
                            <td style={{ width: '12%', textAlign: 'center', border: '1px solid black' }}>VALOR TOTAL</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style={{ width: '40px', textAlign: 'left', border: '1px solid black' }}>
                                "Edad entre 16-24 meses 270-300kg peso vivo. Animales provenientes de la región o en condiciones similares al destino. Provenientes de razas comerciales, productoras de leche y carne Bovinos Dóciles"
                            </td>
                            <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>Novillas de vientre doble propósito</td>
                            <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>
                                "Animales provenientes de predios registrados con su esquema de vacunación. Desparasitados Marcados GSM (guía de Movilización)"
                            </td>
                            <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>ASOCIACION GREMIAL AGROAMBIENTAL UNIDOS</td>
                            <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>901453306-0</td>
                            <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>Unidad</td>
                            <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>3300000</td>
                            <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>0</td>
                            <td style={{ width: '40px', textAlign: 'left', border: '1px solid black' }}>$ -</td>
                        </tr>
                        <tr>
                            <td colSpan="8" style={{ width: '40px', textAlign: 'right', border: '1px solid black' }}>Total</td>
                            <td style={{ width: '40px', textAlign: 'left', border: '1px solid black' }}>$ -</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                    <thead>
                        <tr>
                            ...
                            <td style={{ width: '6%', textAlign: 'left', borderRight: '1px solid black' }}>C.C: 36278775</td>
                            ...
                            <td style={{ width: '10%', textAlign: 'left', borderRight: '1px solid black' }}>&nbsp;</td>
                        </tr>
                        <tr>
                            <td style={{ width: '10%', textAlign: 'left', border: '1px solid black' }}>Nombre del titular:</td>
                            <td style={{ width: '10%', textAlign: 'left', border: '1px solid black' }} colSpan="3">ALBA LUZ MENESES CUELLAR</td>
