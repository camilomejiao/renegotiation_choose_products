...
export const ReportHeadLine = ({dataReport}) => {
                ...
                <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                    <thead>
                        ...
                        <tr>
                            ...
                            <td style={{ width: '10%', border: '1px solid black', textAlign: 'center' }}> $ {dataReport.saldo}</td>
                            <td style={{ width: '15%', border: '1px solid black' }}><strong>VALOR TOTAL INVERTIDO</strong></td>
                            <td style={{ width: '15%', border: '1px solid black', textAlign: 'center' }}> $ {dataReport.invertido}</td>
                            <td style={{ width: '25%', border: '1px solid black' }}><strong>SALDO FINAL DESPUES DE INVERSIÓN :</strong></td>
                            <td style={{ width: '12%', border: '1px solid black', textAlign: 'center' }}> $ {(dataReport.saldo - dataReport.invertido).toLocaleString()}</td>
                        </tr>
                    </thead>
                </table>
                ...
                <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                    ...
                    <tbody>
                            ...
                            return Object.keys(proveedor.productos).map((productoKey, productoIndex) => {
                                ...
                                return (
                                    <tr key={`${key}-${productoIndex}`}>
                                        ...
                                        <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>{producto.precio}</td>
                                        <td style={{ width: '40px', textAlign: 'center', border: '1px solid black' }}>{producto.cantidad}</td>
                                        <td style={{ width: '40px', textAlign: 'left', border: '1px solid black' }}>$ {producto.total}</td>
                                    </tr>
                                );
                            });
                        })}
                        <tr>
                            ...
                            <td style={{ width: '40px', textAlign: 'left', border: '1px solid black' }}>$ {totalSum.toLocaleString()}</td>
                        </tr>
                    </tbody>
                </table>
