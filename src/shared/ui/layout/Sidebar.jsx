  ...
  return (
    <SidebarShell isOpen={isOpen} isMobile={isMobile}>
      ...
      {isMobile && (
        <MobileHeader>
          <strong>Menu</strong>
          <MobileClose type="button" onClick={toggleSidebar} aria-label="Cerrar menu">
            <FaTimes />
          </MobileClose>
        </MobileHeader>
      )}
      ...
      <NavItem>
        <NavLink type="button" data-static="true">
      ...
      <SidebarToggleRow>
        <SidebarToggleBtn type="button" onClick={toggleSidebar}>
